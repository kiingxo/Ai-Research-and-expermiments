# Note (framing): Blueprint proving ground

**Type:** framing — not an experiment result
**Last updated:** 2026-07-26

Blueprint Labs treats hard domains as proving grounds for autonomous systems.
The public Leverage Floor is at
[leverage.blueprintlabsai.tech](https://leverage.blueprintlabsai.tech/).

This note only states research posture. Evidence lives in experiment writeups:

| Claim shape | Where it is tested |
| --- | --- |
...
Product dossiers (high level): [Leverage](../projects/leverage/),
[Apex AI](../projects/apex-ai/).
